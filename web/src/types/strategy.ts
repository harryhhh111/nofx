...
export interface StrategyCalibrationReport {
  ...
  labeled_episode_count: number
  pending_episode_count: number
  ambiguous_episode_count: number
  positive_episode_count: number
  negative_episode_count: number
  episode_hit_rate: number
  average_episode_r: number
  episode_r_count: number
  ...
  episode_stats: StrategySetupEpisodeStat[]
  factor_stats: StrategySetupFactorStat[]
  latest_sample_at?: string
  generated_at: string
}

export interface StrategySetupEpisodeStat {
  regime: string
  setup: string
  action: string
  episodes: number
...
export interface StrategySetupFactorStat {
  regime: string
  setup: string
  action: string
  factor: string
  ...
  conflicting: number
  neutral: number
  positive_when_supporting: number
  negative_when_supporting: number
  positive_when_conflicting: number
  negative_when_conflicting: number
  support_hit_rate: number
  conflict_hit_rate: number
  average_directional_score: number
  predictive_alignment: number
}
...
export interface RiskControlConfig {
  ...
  // Trading leverage limits for opening positions.
  ...
  min_risk_reward_ratio: number // Min structural target / stop anchor ratio
  min_confidence: number // Minimum deterministic setup confidence to open
