...
import {
  coinSource,
  rankingFilter as rankingFilterI18n,
  ts,
        ...
        <div className="p-4 space-y-3 bg-nofx-bg-primary">
          ...
          <div className="grid grid-cols-3 gap-2 pl-6">
            <label className="flex items-center gap-1 text-xs">
              <input
                ...
                onChange={(e) =>
                  update({ use_price_momentum: e.target.checked })
                }
              />
            ...
            <label
              ...
              title={ts(rankingFilterI18n.fundingRateNoSource, language)}
            >
              <input
                type="checkbox"
          ...
          <div className="flex items-center gap-3 pl-6">
            ...
            <input
              ...
              disabled={disabled || !rf.enabled}
              onChange={(e) =>
                update({ max_candidates: Number(e.target.value) || 10 })
              }
