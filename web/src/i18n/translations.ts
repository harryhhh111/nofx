...
export const translations = {
  en: {
    ...
    paperInitialBalanceLabel: 'Paper Initial Balance ($)',
    paperInitialBalanceHint:
      'Virtual USDT used by this paper trader. It is submitted when the trader is created.',
    fetching: 'Fetching...',
    ...
    strategyStudio: {
      ...
      confirmDeleteStrategy:
        'Delete strategy “{name}”? This action cannot be undone.',
      confirmDelete: 'Confirm Delete',
      delete: 'Delete',
      cancel: 'Cancel',
      strategyInUseTitle: 'Strategy is being used',
      strategyInUseDescription:
        'This strategy is assigned to trader(s): {names}. Reassign or delete those traders before deleting the strategy.',
      strategyInUseBackendDescription:
        'This strategy is still assigned to one or more traders. Reassign or delete those traders before deleting the strategy.',
      defaultStrategyCannotDelete:
        'The system default strategy cannot be deleted.',
    ...
    modelConfig: {
      ...
      allModelsClaw: 'NofxOS data payment wallet — pay per request with USDC on Base',
      ...
      fundStep3: '$5-10 USDC lasts a long time',
      back: 'Back',
  ...
  zh: {
    ...
    paperInitialBalanceLabel: '模拟盘初始资金 ($)',
    paperInitialBalanceHint:
      '这个模拟盘交易员使用的虚拟 USDT 资金，创建时会保存为初始余额。',
    fetching: '获取中...',
    ...
    strategyStudio: {
      ...
      confirmDeleteStrategy: '确定删除策略“{name}”吗？删除后无法恢复。',
      confirmDelete: '确认删除',
      delete: '删除',
      cancel: '取消',
      strategyInUseTitle: '策略正在被使用',
      strategyInUseDescription:
        '此策略已分配给交易员：{names}。请先为这些交易员更换策略，或删除对应交易员后再删除策略。',
      strategyInUseBackendDescription:
        '此策略仍被一个或多个交易员使用。请先为交易员更换策略，或删除对应交易员后再删除策略。',
      defaultStrategyCannotDelete: '系统默认策略不能删除。',
      deleteStrategyFailed: '删除策略失败。',
    ...
    modelConfig: {
      ...
      allModelsClaw: 'NofxOS 数据付费钱包 — 用 Base 链 USDC 按次付费',
      setupWallet: '设置钱包',
      ...
      fundStep3: '充入 $5-10 USDC 即可使用很长时间',
      back: '返回',
      startTrading: '开始交易',
  ...
  id: {
    ...
    paperInitialBalanceLabel: 'Saldo Awal Paper ($)',
    paperInitialBalanceHint:
      'USDT virtual yang digunakan trader paper ini. Nilai ini disimpan saat trader dibuat.',
    fetching: 'Mengambil...',
    ...
    modelConfig: {
      ...
      allModelsClaw: 'Wallet pembayaran data NofxOS — bayar per permintaan dengan USDC di Base',
      setupWallet: 'Setup Wallet',
      walletInfo:
      ...
      fundStep3: '$5-10 USDC cukup untuk waktu lama',
      back: 'Kembali',
