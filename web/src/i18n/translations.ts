...
export const translations = {
  en: {
    ...
    uPnLLeveraged: 'Leveraged Price Yield',
    uPnLAccount: 'Account Yield',
    riskControlYield: 'Risk Control Metric',
    accountPnLYieldTooltip:
      'Account Yield = (Total Equity - Initial Balance) / Initial Balance × 100%. Reflects the change in account net equity relative to the initial principal.',
    liqPrice: 'Liq. Price',
    long: 'LONG',
    short: 'SHORT',
  ...
  zh: {
    ...
    leverage: '杠杆',
    unrealizedPnL: '未实现盈亏',
    uPnLLeveraged: '杠杆价格收益率',
    uPnLAccount: '账户收益率',
    riskControlYield: '风控口径',
    accountPnLYieldTooltip:
      '账户净值收益率 = (总权益 - 初始本金) / 初始本金 × 100%，反映账户净值相对初始本金的变化幅度。',
    liqPrice: '强平价',
    long: '多头',
    short: '空头',
    noPositions: '无持仓',
