...
export const translations = {
  en: {
    ...
    paperInitialBalanceHint: 'Virtual USDT used by this paper trader. It is submitted when the trader is created.',
    fetching: 'Fetching...',
    ...
    strategyStudio: {
      ...
      strategyDeleted: 'Strategy deleted',
	      confirmDeleteStrategy: 'Delete strategy “{name}”? This action cannot be undone.',
	      confirmDelete: 'Confirm Delete',
	      delete: 'Delete',
	      cancel: 'Cancel',
	      strategyInUseTitle: 'Strategy is being used',
	      strategyInUseDescription: 'This strategy is assigned to trader(s): {names}. Reassign or delete those traders before deleting the strategy.',
	      strategyInUseBackendDescription: 'This strategy is still assigned to one or more traders. Reassign or delete those traders before deleting the strategy.',
	      defaultStrategyCannotDelete: 'The system default strategy cannot be deleted.',
  ...
  zh: {
    ...
    paperInitialBalanceHint: '这个模拟盘交易员使用的虚拟 USDT 资金，创建时会保存为初始余额。',
    fetching: '获取中...',
    ...
    strategyStudio: {
      ...
      strategyDeleted: '策略已删除',
	      ...
	      strategyInUseDescription: '此策略已分配给交易员：{names}。请先为这些交易员更换策略，或删除对应交易员后再删除策略。',
	      strategyInUseBackendDescription: '此策略仍被一个或多个交易员使用。请先为交易员更换策略，或删除对应交易员后再删除策略。',
  ...
  id: {
    ...
    paperInitialBalanceHint: 'USDT virtual yang digunakan trader paper ini. Nilai ini disimpan saat trader dibuat.',
    fetching: 'Mengambil...',
